import { ApiAdapter, ConversationMessage, OpenRouterModel, MessageContent } from './ApiAdapter';
...
export class OpenAIApiAdapter implements ApiAdapter {
  ...
  private static readonly OPENAI_MODELS: OpenRouterModel[] = [
    {
      id: 'gpt-4o',
  ...
  async fetchAvailableModels(): Promise<OpenRouterModel[]> {
    ...
    return OpenAIApiAdapter.OPENAI_MODELS;
  }
